...
<DefinitionBlock term="Absolute Knappheit" icon="🔒">
  **Absolute Knappheit** bedeutet, dass das Angebot eines Gutes perfekt fixiert ist und nicht auf eine steigende Nachfrage reagieren kann. Bei Bitcoin wird dies durch die dezentrale Verifizierung tausender [Nodes](/blog/was-ist-ein-bitcoin-node/) erzwungen. Während Gold nur 'relativ knapp' ist (Angebot steigt bei höherem Preis), bleibt Bitcoin bei exakt 21 Millionen — egal wie hoch der Preis oder die Nachfrage ist.
</DefinitionBlock>
...
- [Das Bitcoin Halving](/blog/bitcoin-halving/) → Das Event, das die Knappheit physisch umsetzt.
- [Was ist Bitcoin Mining?](/blog/bitcoin-mining-erklaert/) → Warum Arbeit nötig ist, um Knappheit zu erzeugen.
- [Was bestimmt den Preis?](/blog/was-bestimmt-den-bitcoin-preis/) → Wie Knappheit auf Nachfrage trifft.
- [Public vs. Private Keys](/blog/public-private-keys/) → Warum Schlüsselverlust Bitcoin noch knapper macht.
- [Was ist eine Bitcoin Node?](/blog/was-ist-ein-bitcoin-node/) → Werden Sie selbst zum Wächter des 21-Millionen-Limits.
