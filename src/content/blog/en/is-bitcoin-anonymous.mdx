...
| Heuristic | How it Works | Goal |
|---|---|---|
| **Common Input** | If address A and B are used in the same transaction, they belong to the same person. | Mapping Wallets |
| **Change Analysis** | Identifying which output address returned 'change' to the sender's wallet. | Tracking Fund Flow |
| **Merchant Tagging**| Labeling addresses known to belong to regulated entities or dark markets. | Identifying Risk |
