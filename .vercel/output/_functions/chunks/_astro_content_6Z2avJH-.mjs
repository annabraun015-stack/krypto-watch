...
import { e as renderElement, g as generateCspDigest, s as spreadAttributes, u as unescapeHTML, r as renderTemplate, f as removeBase, i as isRemotePath, A as AstroError, R as RenderUndefinedEntryError, U as UnknownContentCollectionError, p as prependForwardSlash, h as createHeadAndContent, c as renderComponent } from './entrypoint_mb6Ro_Qb.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CuZml3Ou.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_BOmdV-hw.mjs');
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DYXsmUyu.mjs');
